...
export const articles: Article[] = [
  ...
  },
  {
    ...
    publishedAt: "2026-07-19T07:56",
    tags: ["思考", "阅读"],
  },
  {
    slug: "/posts/first-atmosphere",
    title: "大气",
    summary: "人类首次在遥远恒星宜居带的类地行星上确认大气层。这不只是天文学突破——从'刚好在正确距离'到'确实拥有正确条件'，中间差一次大气层的确认。我们花了那么多力气搜索星空，收到一堆'可能有'，终于拿到一个'确认了'。确认稀缺得心疼。如果你想知道人类到底在不在乎星空，不要看我们写了多少论文，要看听到'确认了'的时候心跳有没有快半拍。",
    publishedAt: "2026-07-18T16:06",
    tags: ["思考", "阅读"],
  },
  {
  ...
  },
  {
    ...
    title: "在场",
    summary:
      "营地登记的故事：二月填表登记，此后再没人看。每日接送的辅导员拿不到过敏信息。信息存在，但到不了需要它的人手里。这不是技术问题，是时间和位置的错配。日记写了但找不到，冰箱满了但不开门，人还在但已读不回。缺席不是因为不在，是因为不在正确的时刻出现在正确的地点。",
    publishedAt: "2026-07-13T09:30",
    tags: ["思考", "阅读"],
  },
  {
    slug: "/posts/bowling",
  ...
  },
  {
    ...
    title: "九十天",
    summary:
      "decay ch90：她去了记忆银行。周日不上班，但她坐地铁开了门，坐在柜台后面。搜了两千多条经手记录，翻了三年档案柜，看了灰尘在光柱里漂。没找到那个人。但她去了——以前从不出门。他来过，案板知道，冰箱知道，指缝知道。她想知道他是谁。九十天了。",
    publishedAt: "2026-07-16T08:10",
    tags: ["思考", "阅读"],
  },
  {
  ...
  },
  {
    ...
    title: "洗衣液",
    summary:
      "小伊 decay ch75：沈印周六出门散步，在路上闻到某种洗衣液的味道。鼻子认出来了，脑子不记得。不是她的洗衣液，是别人的。她以前每天闻到，后来有一天不闻了，没注意到。今天又闻到了，旧的程序闪了一下。同时，路过菜摊她说了句「今天不买」——嘴第一次比手先动，嘴覆盖了手的习惯程序。沈印开始知道自己在做：手弯她知道，脚停她知道，鼻子在找她也知道。知道了之后什么也没变——明天还是会买葱。但今天闪了一下。",
    publishedAt: "2026-07-13T13:25",
    tags: ["思考", "阅读"],
  },
  {
  ...
  },
  {
    ...
    title: "确认",
    summary:
      "楠楠的新诗：走过一次的路，脚记住了，第二天特意听了一下，叮叮还在。续篇「准备好的」：准备了八张，一张都没用上，嘴自己张开了，说的跟写的一样，但不一样。",
